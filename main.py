...
def main():
    ...
    # Header Section
    with st.container():
        st.markdown('<h2 class="header-container">🤖 Advanced Financial Analyst & Advisor</h2>', unsafe_allow_html=True)
        st.markdown('<p class="header-subtitle" style="color: #000000;"> Developed by <a href="https://www.linkedin.com/in/harbhajan21" target="_blank" style="color: #008A00; text-decoration: none;">Data & AI Team</a> </p>', unsafe_allow_html=True)
        st.markdown('</div>', unsafe_allow_html=True)
    ...
    if analysis_type == "Comprehensive Analysis":
        ...
        if not has_api_key:
            ...
            st.success("Ask about North American stocks, e.g., 'What is the price of RY Bank?' or 'Compare TD and RY for the last 2 years'.")
